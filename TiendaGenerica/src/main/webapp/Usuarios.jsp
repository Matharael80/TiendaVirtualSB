	          		...
	          		<div class="card-body">
						<div class="text-center">
							<div class="form-group">
								<label>Cédula</label>
								<%
									String cedula_usuario = (String)request.getAttribute("cedula_usuario");
									if(cedula_usuario == null)cedula_usuario = "";
								%>
								<input type="number" class="field"
									name="cedula_usuario" placeholder="Escribe tu cédula" required value="<%=cedula_usuario%>">
							</div>
							<div class="form-group">
								...
								<input type="text" pattern="[A-Za-z ]+" class="field"
									name="nombre_usuario" placeholder="Escribe tu nombre completo" value="<%=nombre_usuario%>"><br />	
							</div>
							<div class="form-group">
								<label>Correo Electrónico</label>
								<%
									String email_usuario = (String)request.getAttribute("email_usuario");
									if(email_usuario == null)email_usuario = "";
								%>
								<input type="email"
									class="field" name="email_usuario"
									placeholder="Escribe tu correo electrónico" value="<%=email_usuario%>"><br />
							</div>
							<div class="form-group">
								<label>Usuario</label>
								<%
								...
								%>
								<input type="text" pattern="[A-Za-z0-9]+" class="field"
									name="usuario" placeholder="Escribe tu usuario" value="<%=usuario%>">
							</div>
							<div class="form-group">
								...
								<input type="password" class="field"
									name="password" placeholder="Escribe tu contraseña"
